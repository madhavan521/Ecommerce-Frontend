...
body:JSON.stringify(data)
  ...
  //   setDiscount,setFeatures,setImage1,setImage2,setImage3,setName,setPrice,setStock,name,image,oneimage,twoimage,stock,price,discount,description,features,catagory }
...
<div className='my-4'>
  <Link to='/admin' className=''> <h6 className='text-center'> Back To AdminPanel </h6></Link>   
    ...
    <input type="text" className='form-control' 
    value={image} onChange={(e)=>setImage1(e.target.value)}/>
    </label> 
    <br />
    <label htmlFor="" className='form-label mx-3 '>Image2 Url
    <input type="text" className='form-control' 
    value={oneimage} onChange={(e)=>setImage2(e.target.value)}/>
    </label> 
    <br /><label htmlFor="" className='form-label mx-3 '>Image3 Url
    <input type="text" className='form-control' 
    value={twoimage} onChange={(e)=>setImage3(e.target.value)}/>
    </label> 
    <br />
